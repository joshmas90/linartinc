  ...
  return (
    <footer className="bg-[#0b0d10] text-white">
      <div className="site-container py-16 sm:py-20">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="mt-1 text-[0.58rem] uppercase tracking-[0.24em] text-white/42">Construction Inc.</div>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-3 pt-7 text-[11px] text-white/34 sm:flex-row sm:items-center sm:justify-between">
